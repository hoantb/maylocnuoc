...
class SanPham(models.Model):
    ...
    the_loai = models.ForeignKey(TheLoai, null=False, blank=False, on_delete=models.CASCADE, related_name="san_phams")
    ...
    ngay_tao = models.DateTimeField(auto_now_add=True, blank=True, null=True)
